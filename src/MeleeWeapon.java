...
public class MeleeWeapon extends Weapon {
  ...
  public MeleeWeapon(String type, int strength, int damage, double lengthCM,
                     double weightKG, int sharpness) {
    this.type = type;
  ...
  public boolean testAll() {
    ...
    weapon.setType("Axe");
    if (!weapon.getType().equals("Axe"))
      return false;

    weapon.setStrength(20);
    if (weapon.getStrength() != 20)
      return false;
    ...
    if (weapon.getLengthCM() != 45.0)
      return false;

    weapon.setWeightKG(3.0);
    if (weapon.getWeightKG() != 3.0)
      return false;

    weapon.setSharpness(9);
    if (weapon.getSharpness() != 9)
      return false;

    weapon.setStrMod(2);
    if (weapon.getStrMod() != 2)
      return false;

    weapon.setDexMod(1);
    if (weapon.getDexMod() != 1)
      return false;

    weapon.setConMod(3);
    if (weapon.getConMod() != 3)
      return false;

    weapon.setIntMod(4);
    if (weapon.getIntMod() != 4)
      return false;

    weapon.setWisMod(5);
    if (weapon.getWisMod() != 5)
      return false;

    weapon.setChaMod(6);
    if (weapon.getChaMod() != 6)
      return false;
